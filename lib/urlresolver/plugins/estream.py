...
class EstreamResolver(UrlResolver):
    ...
    def get_media_url(self, host, media_id):
        ...
        if html:
            ...
            headers = '|User-Agent=%s&Referer=%s&Cookie=%s' % (urllib.quote_plus(common.FF_USER_AGENT), urllib.quote_plus('https://www.estream.to/'), urllib.quote_plus(self.__get_cookies(html)))
    ...
    def get_url(self, host, media_id):
        return 'https://%s/%s.html' % (host, media_id)
